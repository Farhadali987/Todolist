...
console.log(mainTask);
  ...
  let renderTask = <h2 className="
  hover:text-yellow-700 "> No Task Available</h2>
  ...
  return (
    <>
    <h1 className='hover:text-amber-500 bg-black text-white p-5 text-5xl font-bold text-center ' >Farhad Todo List</h1>
   <form onSubmit={submitHandler}>
    ...
    <button className='hover:border-l-indigo-800 bg-black text-white px-4 py-3 text-2xl font-bold rounded m-5'>Add Task</button>
   </form>
   <hr />
